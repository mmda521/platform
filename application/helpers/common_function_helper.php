...
if( !function_exists("result_to_towf_new") ){
 ...
 function result_to_towf_new($ret,$errmsg){
	$result_arr = array();
	$result_arr["resultcode"] = (string)$ret;
	$result_arr["errmsg"] = $errmsg;
	//file_put_contents("D:\abc.txt",var_export($result_arr["resultcode"],true)."\r\n",FILE_APPEND);
...
if( !function_exists("result_to_towf_new2") ){
 ...
 function result_to_towf_new2($ret,$errmsg,$data,$goods_Id,$field_Id){
	$result_arr = array();
	$result_arr["resultcode"] = (string)$ret;
	$result_arr["errmsg"] = $errmsg;
	$result_arr["data"] = $data;
	$result_arr["goods_Id"] = $goods_Id;
	$result_arr["field_Id"] = $field_Id;
	//file_put_contents("D:\abc.txt",$result_arr,FILE_APPEND);
	return json_encode($result_arr);
}
...
if( !function_exists("result_to_towf_new3") ){
	
 function result_to_towf_new3($ret,$errmsg,$data,$goods_Id,$field_Id,$pages){
	$result_arr = array();
	$result_arr["resultcode"] = (string)$ret;
	$result_arr["errmsg"] = $errmsg;
	$result_arr["data"] = $data;
...
if( !function_exists("result_to_towf_new4") ){
	
 function result_to_towf_new4($ret,$errmsg,$data,$goods_Id,$field_Id,$pages,$Reason){
	$result_arr = array();
	$result_arr["resultcode"] = (string)$ret;
	$result_arr["errmsg"] = $errmsg;
	$result_arr["data"] = $data;
