			...
			<form class="layui-form">
                <div class="layui-form-item">			
					...
					<div class="layui-input-inline">
						<select name="quiz" id="quiz" lay-filter="test">
				...
				<input type="hidden" value="<?php if(isset($info)) echo $info;?>" name="Tdc_id"/>
		      <div id="result"></div>
				<div class="layui-form-item">
		...
		<script>
			layui.use(['form','layer'], function(){
			  ...
			  var form = layui.form();
			   ...
			   form.on('submit(demo1)',function(jieguo){
				  $.ajax({
					 type:"post", 
					 url:"<?php echo site_url('Admin/shenhe_tijiao')?>",
					 data:{
						 ...
						 parent.layer.open({
                            ...
                            success: function(layero){
                             var btn = layero.find('.layui-layer-btn');
							     ...
							     href:'<?php echo site_url("Admin/shenhe");?>',
							 });							
                            }							
						 }) ;
						//
