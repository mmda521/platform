...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url(); ?>webroot/TDC_Admin/plugins/font-awesome/css/font-awesome.min.css" />
		<link rel="stylesheet" href="<?php echo base_url(); ?>webroot/TDC_Admin/css/layout.css" media="all" />
	</head>
	...
	<body>
		...
		<script src="<?php echo base_url(); ?>webroot/TDC_Admin/plugins/layui/layui.js "></script>
		<script src="<?php echo base_url(); ?>webroot/TDC_Admin/js/layout.js "></script>
		<!--<script>
            //这是js的枚举，哈哈。
			var closedEnum = {
