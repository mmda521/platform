...
<html>
	...
	<body>
		<div class="layui-layout layui-layout-admin">
					...
					<ul class="layui-nav admin-header-item">
						...
						<li class="layui-nav-item">
							<a href="javascript:;" class="admin-header-user">
								<img src="<?php echo base_url(); ?>webroot/TDC_Admin/images/0.jpg" />
								<span>beginner</span>
							</a>
							<dl class="layui-nav-child">
								...
								<dd>
									<a href="<?php echo site_url('Admin/login');?>"><i class="fa fa-sign-out" aria-hidden="true"></i> 注销</a>
								</dd>
							</dl>
						</li>
					</ul>
			...
			<script type="text/javascript" src="<?php echo base_url(); ?>webroot/TDC_Admin/datas/nav.js"></script>
